//package com.example.springbootgatewayserver.confige;
//
...
// * @data: 20:51
// */
////由于作者使用的是最新的 spring-boot 2.5.5 版本，从 ErrorController 中删除了 getErrorPath() API，
//// 但spring-cloud-starter-netflix-zuul 2.2.7.RELEASE 仍然调用此 API 并导致此错误
////解决：  创建BeanPostProcessor拦截 lookupHandler 方法的调用
//@Configuration
